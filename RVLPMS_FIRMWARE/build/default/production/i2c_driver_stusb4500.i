...
i2c_master_wait();
i2c_master_start();
if (ok == 0) ok = i2c_master_send_byte((device << 1) | 0);
if (ok == 0) ok = i2c_master_send_byte(reg);
while (ok == 0 && len--) {
...
if (ok == 0) ok = i2c_master_send_byte((device << 1) | 0);
if (ok == 0) ok = i2c_master_send_byte(reg);
if (ok == 0) i2c_master_repeat_start();
if (ok == 0) ok = i2c_master_send_byte((device << 1) | 1);
if (ok == 0) {
while (len--) {
*data++ = i2c_master_receive_byte(len ? 0 : 1);
}
}
i2c_master_stop();
