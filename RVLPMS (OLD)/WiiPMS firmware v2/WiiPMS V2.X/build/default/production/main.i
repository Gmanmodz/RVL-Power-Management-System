...
_delay((unsigned long)((1100)*(32000000/4000.0)));
TRISAbits.TRISA2 = 0;
RA2 = 0;
...
else if(SYS_ENABLE && btn_time<=50 && !VBUS_CHRG_STATE[1]) {
...
if(!SYS_ENABLE && VBUS_CHRG_STATE[1]==0 && !btn_is_debounced && RA5 && BQ_adc_state==0 && !set_stusb4500) {
PWM_power_down();
asm("clrwdt");
asm("sleep");
asm("reset");
